...
You can find a more in-depth example here: https://github.com/khulnasoft/tunnel-sarif-demo/blob/master/.github/workflows/scan.yml
...
### Using Tunnel to scan Infrastructure as Code
